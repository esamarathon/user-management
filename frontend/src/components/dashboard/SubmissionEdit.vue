      ...
      <form v-if="selectedSubmission" class="layout-padding" autocomplete="off">
        <div class="layout-row layout-wrap">
          <md-field class="large-field flex-none" :class="getValidationClass('game')">
            ...
            <md-input name="game" id="game" v-model="selectedSubmission.game" :disabled="!editable('game')" />
          ...
          <md-autocomplete md-input-placeholder="Twitch game" class="large-field flex-50" v-model="selectedSubmission.twitchGame" :md-options="gameSearch" @md-changed="searchGames(selectedSubmission.twitchGame)" :class="getValidationClass('twitchGame')" :disabled="!editable('twitchGame')">
          ...
          <md-field class="large-field flex-50" :class="getValidationClass('leaderboards')">
            ...
            <md-input name="leaderboards" id="leaderboards" v-model="selectedSubmission.leaderboards" :disabled="!editable('leaderboards')" />
          ...
          <md-field class="small-field flex-25" v-if="hasAnyPermission('Edit Runs', 'Admin')">
            ...
            <md-select v-model="selectedSubmission.status" name="status" id="status" @md-selected="initTeams()" :disabled="!editable('status')">
          ...
          <md-field class="small-field flex-none" :class="getValidationClass('category')">
            ...
            <md-input name="category" id="category" v-model="selectedSubmission.category" :disabled="!editable('category')" />
          ...
          <md-field class="small-field flex-none" :class="getValidationClass('estimate')">
            ...
            <md-input name="estimate" id="estimate" v-model="selectedSubmission.estimate" :disabled="!editable('estimate')" />
          ...
          <md-autocomplete class="small-field" v-model="selectedSubmission.platform" :md-options="platforms" :class="getValidationClass('platform')" :disabled="!editable('platform')">
          ...
          <md-field class="small-field flex-none">
            ...
            <md-select v-model="selectedSubmission.runType" name="runType" id="runType" @md-selected="initTeams()" :class="getValidationClass('runType')" :disabled="!editable('runType')">
          ...
          <div class="team-setup flex-100 layout-column" v-if="selectedSubmission.runType !== 'solo'">
            ...
            <draggable v-model="selectedSubmission.invitations" group="members" class="layout-row layout-wrap" :disabled="!editable('teams')" :class="{'disabled-draggable': !editable('teams')}">
          ...
          <md-field class="large-field flex-100" :class="getValidationClass('comment')">
            ...
            <md-textarea name="comment" id="comment" v-model="selectedSubmission.comment" md-counter="100" :disabled="!editable('comment')" />
          ...
          <div class="incentives flex-100 layout-column">
            <div class="layout-row layout-start-center layout-wrap" v-if="editable('incentives')">
            ...
            <div class="incentive" v-for="(incentive, index) in selectedSubmission.incentives" :key="incentive._id">
              ...
              <div class="incentive-body">
                ...
                <md-field class="large-field flex-none" :class="getValidationClass(`incentives.$each.${index}.description`)">
                  ...
                  <md-textarea name="incentivedescription" v-model="incentive.description" :disabled="!editable('incentives')" />
                ...
                <div v-if="incentive.type === 'bidwar'" class="layout-row layout-wrap">
                  <md-field class="small-field flex-none">
                    <md-select v-model="incentive.bidwarType" name="bidwarType" id="bidwarType" :disabled="!editable('incentives')">
                  ...
                  <div v-if="incentive.bidwarType === 'freeform'" class="layout-row layout-wrap">
                    <md-field class="small-field flex-none" :class="getValidationClass(`incentives.$each.${index}.freeformMin`)">
                      ...
                      <md-input type="number" name="freeformMin" v-model="incentive.freeformMin" :disabled="!editable('incentives')" />
                    ...
                    <md-field class="small-field flex-none" :class="getValidationClass(`incentives.$each.${index}.freeformMax`)">
                      ...
                      <md-input type="number" name="freeformMin" v-model="incentive.freeformMax" :disabled="!editable('incentives')" />
                  ...
                  <div v-if="incentive.bidwarType === 'options'" class="flex-100">
                    <md-field class="small-field flex-none">
                      ...
                      <md-textarea name="incentiveoptions" v-model="incentive.options" :disabled="!editable('incentives')" />
                    </md-field>
                  </div>
                </div>
              </div>
